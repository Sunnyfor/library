...
object ThemeConfig {
     ...
     * 更新主题
     */
    fun applyTheme(context: Context, orientation: Int = 1) = with(context) {
        when {
            ...
            AppConfig.isNightTheme -> {
                ...
                val primary =
                    if (orientation == 2) {
                        getPrefInt(PreferKey.cPrimary, getCompatColor(R.color.color_theme_land))
                    } else {
                        getPrefInt(PreferKey.cPrimary, getCompatColor(R.color.color_theme))
                    }
                ...
                val accent =
                    if (orientation == 2) {
                        ...
                        getPrefInt(PreferKey.cAccent, getCompatColor(R.color.color_theme))
                    }
